    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<a href='$mlink' class='prev has-background'><span>上一篇：</span><h4>{$preRow['title']}</h4></a> ";
                $this->PreNext['preimg'] = "<a href='$mlink'><img src=\"{$preRow['litpic']}\" alt=\"{$preRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['pre'] = "<a class='prev has-background'><span>上一篇：</span><h4>没有了</h4></a> ";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<a href='$mlink' class='nextv has-background'><span>下一篇：</span><h4>{$nextRow['title']}</h4></a> ";
                $this->PreNext['nextimg'] = "<a href='$mlink'><img src=\"{$nextRow['litpic']}\" alt=\"{$nextRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['next'] = "<a class='nextv has-background'><span>下一篇：</span><h4>没有了</h4></a> ";
